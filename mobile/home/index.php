...
<div id="page">
    ...
    <?php if($title <> "Print Data Pin"): ?>
        <div class="header header-fixed header-logo-center">
            ...
            <a href="./" class="header-title"> <h2 style="text-align:center; padding:10px;box-shadow:-20px -20px 20px #FFA500; border:1px; font-size:20px;"><span style="color:#FFA500; font-size:20px">B</span>PAY</h2>
</a>
            <?php if($title == "Homepage"){?>
                <a href="#" class="font-17 header-icon header-icon-1"><span >😍</span></a>
            <?php } else{ ?>
