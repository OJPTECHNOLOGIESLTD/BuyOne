                ...
                <div class="px-2">
                    ...
                    <div class="row pt-5 mb-3">
                        ...
                        <div class="col-12 text-center font-15 mt-3">
                            <a class="text-white"<b>BPAY COMPANY</b></a>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    if(resp == 0){
                        ...
                        swal('Alert!!',"Sorry, Your Account Have Been Blocked By Admin. Please Contact support@bpay.company For Futher Support.","error");
                    }
                   else{
