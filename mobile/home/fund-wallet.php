    ...
    <div class="card card-style bg-theme pb-0">
        <div class="content" id="tab-group-1">
            <div class="tab-controls tabs-small tabs-rounded" data-highlight="bg-highlight">
                ...
                <a href="#" data-active data-bs-toggle="collapse" data-bs-target="#tab-2">Card</a>
            ...
            <div data-bs-parent="#tab-group-1" class="collapse show" id="tab-1">
                <div class="text-center">
                    ...
                    <p class="mb-2 text-dark font-600 font-16"><b>Account No:</b> <?php echo $data->sFidelityBank; ?>5080159986</p>
                    <button class="btn btn-primary font-700 rounded-xl mt-3" onclick="copyToClipboard('5080159986')">Copy Account No</button>
                    <hr/>
                    ...
                    <?php echo $data->sRolexBank; ?></p>
                    <p class="mb-2 text-danger font-600 font-15"><b>Note: </b> Automated bank transfer attracts additional charges of  only.</p>
            ...
            <div data-bs-parent="#tab-group-1" class="collapse show" id="tab-2">
                ...
                <form method="post">
                    ...
                    <button type="submit" id="fund-with-paystack" name="fund-with-paystack" style="width: 100%;" class="btn btn-full btn-l font-600 font-15 gradient-highlight mt-4 rounded-s">Pay Now</button>
                </form>
                <?php else : ?>
                <h3 class="text-center text-danger">Oops!! Paystack Payment Is Disabled, Please Contact Admin</h3>
                <?php endif; ?>
            </div>
