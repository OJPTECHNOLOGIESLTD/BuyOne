...
<style>
    body{background-image:url("../../assets/img/queen.png");  background-repeat: no-repeat; background-size: cover;}
    .card{background: #ffffffdd; margin:20px;}
    .form-control{
    ...
    <div class="page-content mt-2">
        ...
        <div class="card card-style">
            ...
            <div class="text-center">
                    <h2 class="class="mb-3 text-warning mt-5"" id="accountname" ><span style="color:#0B153C;">Welcome Back</span</h2>
                    <h1 class="font-25 mb-3 text-white" id="accountname2"><span style="color:#0B153C;">Login To </span><br/><span style="display:flex; justify-content: center; gap: 1px;
                    "> 
                    <span style="color:#FFA500;">B</span><SPAN  style="color:#0B153C">PAY</SPAN></h1></span>
                ...
                <div class="px-2">
                    ...
                    <div class="row pt-5 mb-3">
                        <div class="col-12 text-center font-15">
                            <a class="text-white" href="../recovery/"> <span style="color:#0B153C;">Forget Password? Recover It</span></a> 
                        </div>
                        <div class="col-12 text-center font-15 mt-2">
                            <a class="text-white" href="../register/" ><span style="color:#FFA500;">New User? Create Account</span></a>
                        </div>
                        <div class="col-12 text-center font-15 mt-2">
                            <a class="text-white"  id="loginMessage" ><span style="color:#FFA500;"></span></a>
                        </div>
...
$("document").ready(function(){
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    if(resp == 0){
                        ...
                        swal('Alert!!',"Sorry, Your Account Have Been Blocked. Please Contact support@bpay.company.","error");
                    }
                   else{
                        swal('Alert!!',"Unknow Error, Please Contact support@bpay.company","error");
                   }
 ...
 function checkIfPhoneNumberSaved() {
        ...
        if($phone != null && $phone != ""){
            let msg='<p class="mb-3"><a href="javascript:showNumber();"><b class="text-white"><span style="color:#292D32; font-size:13px;">Login With Another Account?</span></b></a></p>';
            $("#loginMessage").after(msg);
