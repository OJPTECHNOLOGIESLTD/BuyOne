<?php
	...
	class ApiModel extends Model{
		...
		public function getUserByEmail($email){
	    	...
	    	$c="SELECT sId,sFname,sLname,sEmail,sWallet FROM subscribers WHERE sEmail=:e";
		...
		//Topup UserAccount with Paystatck
		/*public function paystackTopUp($ref){
			$dbh=self::connect();
			
			//check if payment has been made before
			$transaction_made_sql = "SELECT COUNT(*) AS total_transactions FROM `transactions` WHERE `transref`=:ref;";
			$transaction_made_sql_query = $dbh->prepare($transaction_made_sql);
			
            $transaction_made_sql_query->bindParam(':ref', $ref, PDO::PARAM_STR);
            
            $transaction_made_sql_query->execute();
            
            $total_transactions = $transaction_made_sql_query->fetch(PDO::FETCH_OBJ);
