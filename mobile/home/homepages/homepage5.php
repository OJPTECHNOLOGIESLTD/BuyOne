...
<div class="card notch-clear rounded-0 mb-n5 mt-0" data-card-height="200" style="background-color:<?php echo $sitecolor; ?>;">
                    ...
                    <div class="splide__list" id="single-slider-1-list" style="transform: translateX(-624px);">
                            ...
                            <div class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1" style="width: 312px;">
                                <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/bpay11.jpeg" />
                                </div>
                            </div>
                           
                            <div class="splide__slide" id="single-slider-1-slide02" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/bpay12.jpeg" />
                                </div>
                            </div>
                            
                            <div class="splide__slide" id="single-slider-1-slide03" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/bpayonline.jpeg" />
                                </div>
                            </div>
                            ...
                            <div class="splide__slide splide__slide--clone" aria-hidden="true" tabindex="-1" style="width: 312px;">
                                <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/bpay8.jpeg" />
                                </div>
                            </div>
                           
                            <div class="splide__slide" id="single-slider-1-slide02" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/bpay10.jpeg" />
                                </div>
                            </div>
                            
                            <div class="splide__slide" id="single-slider-1-slide03" aria-hidden="true" tabindex="-1" style="width: 312px;">
                               <div class="card card-style bg-20" data-card-height="190" style="height: 190px;">
                                    <img class="img-fluid" style="height: 190px;" src="../../assets/img/ads/bpay13.jpeg" />
                                </div>
                            </div>
        ...
        <div class="card card-style mt-n3">
            <div class="content mb-3 mt-3">
               <div>
                  <h5><span style='color:#FFA500'>B</span>PAY Services</h5>
                <hr/>
               </div>
...
<!-- Your link with Font Awesome icons -->
<a href="" class="col-4 mt-2">
    <span class="icon icon-l shadow-l rounded-sm" style="color:#00cc00;">
       <i class="fas fa-plane"></i>

    </span>
    <p class="mb-0 pt-1 font-13">Flight</p>
</a>
                ...
                <!--    </a>-->
                 ...
                 <!--<a href="hotel_booking.php" class="col-4 mt-2">-->
    <a href="#" class="col-4 mt-2">
    <span class="icon icon-l shadow-l rounded-sm" style="color:#3366cc;">
        <i class="fa fa-hotel font-18"></i>
    </span>
    <p class="mb-0 pt-1 font-13">Hotel Booking</p>
</a>

<!-- Ride Booking (Duplicated) -->
<a href="#" class="col-4 mt-2">
    <span class="icon icon-l shadow-l rounded-sm" style="color:#ff6600;">
        <i class="fa fa-car font-18"></i>
    </span>
    <p class="mb-0 pt-1 font-13">Ride Booking</p>
</a>
                    ...
                    <a href="transfer" class="col-4 mt-2">
    <span class="icon icon-l shadow-l rounded-sm" style="color:#cc0066;">
        <i class="fas fa-exchange-alt font-18"></i> <!-- Changed icon class to fas fa-exchange-alt -->
    </span>
    <p class="mb-0 pt-1 font-13">Transfer</p>
</a>
