<?php
	...
	class Model{
		...
		public static $dbName="bpaycomp_new"; //Database Name
		public static $username="bpaycomp_new"; // Database Username
		public static $password="admin@25..25"; //Database Password

        public static $dbh;
        
		public $emailUsername="noreply@bpay.company"; //Support Email Address
		public $emailPassword="admin@25..25"; //Support Email Password
