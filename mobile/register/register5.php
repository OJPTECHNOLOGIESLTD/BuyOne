...
<body>
    <div class="container-fluid">
        ...
        <div class="bottom">
            <h2 style="text-align:center; padding:-5px 5px;box-shadow:-20px -20px 20px #FFA500; border:1px; font-size:20px;">
                <span style="color:#FFA500; font-size:20px">B</span>PAY
            </h2>
            ...
            <form id="reg-form" method="post">
                ...
                <div id="nextregDiv" style="display:none;">
                    ...
                    <div class="form-group">
                        <i class="la la-user"></i> &nbsp &nbsp
                        <label for="transpin">Transaction Pin</label> <br>
                    ...
                    <div class="form-group">
                        ...
                        <label for="referal">Referral</label> <br>
                        <input type="number" name="referal" value="<?php if(isset($_GET["referral"])): echo $_GET["referral"]; endif; ?>" class="form-control" placeholder="Who referred you?" >
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="checkbox" id="agree" name="agree" required>
                        <label for="agree">By checking this box, you agree to the privacy and agreement of this app.</label>
                    </div>
                    <br>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        $("document").ready(function(){
            ...
            $("#next-btn").click(function(){
                let $msg = "";
                $('#next-btn').removeClass("btn-primary").addClass("btn-secondary").html('<i class="fa fa-spinner fa-spin" aria-hidden="true"></i> Processing ...');
                ...
                if($msg != ""){
                    swal("Alert!!",$msg,"info");
                    $('#next-btn').removeClass("btn-secondary").addClass("btn-primary").html("Continue");
                    return;
                }
            ...
            $('#reg-form').submit(function(e){
                ...
                if(!$("#agree").is(":checked")){$msg="You must agree to the privacy and agreement of this app.";}
                ...
                $('#submit-btn').removeClass("btn-primary").addClass("btn-secondary").html('<i class="fa fa-spinner fa-spin" aria-hidden="true"></i> Processing ...');
                ...
                $.ajax({
                    ...
                    success:function(resp){
                        ...
                        if(resp == 0){
                            ...
                            swal('Alert!!',"Unknown Error, Please Contact Admin","error");
                        }

                        $('#submit-btn').removeClass("btn-secondary").addClass("btn-primary").html("Register");
                        $('#next-btn').removeClass("btn-secondary").addClass("btn-primary").html("Register");
                    }
                })
            });
        });
