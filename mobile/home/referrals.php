...
<div class="row mb-0">
    ...
    border-color: #FFA500; /* Optional: change border color to match */
               ...
               <div>
                    ...
                    <button class="btn btn-danger btn-sm mt-2 .custom-btn-orange" style="border-radius:5rem; background-color: #FFA500; color:#0B153C;" onclick="copyToClipboard('<?php echo $siteurl."mobile/register/?referral=".$data->sPhone; ?>')">Copy Link</button>
                    <a href="transfer" class="btn btn-success btn-sm mt-2 .custom-btn-orange" style="border-radius:5rem; margin-left:5px; background-color: #FFA500; color:#0B153C;">Withdraw</a>
                </div>
            </div>
        </div>
